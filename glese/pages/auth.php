 <div class="card col-md-6 offset-3">
    ...
    <div class="card-body">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            Email <input type="email" id="email" onblur="verifemail()" name="email" class="form-control" required>
            <span class="text-danger" hidden id="erreuremail">email existant</span><br>
...
<script>
    ...
    function verifemail(){
        ...
        $.ajax({
            url : "http://localhost/glese/public/json/user.php?action=findUser&email="+email.value,
            dataType : "json",
            method : "GET",
            success : function(dataResult){
                if(dataResult!="0"){
